...
export const MerchantInviteUserEmail = ({
  ...
  inviteFromIp,
  inviteFromLocation,
}: MerchantInviteUserEmailProps) => {
  const previewText = `Join ${invitedByUsername} on Baggit Merchant`;
        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          ...
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-[#eaeaea] border-solid p-[20px]">
						<Section className="mt-[32px]">
							<Container className='bg-black size-20 aspect-square rounded-full'>
...
} as MerchantInviteUserEmailProps;

export default MerchantInviteUserEmail;
