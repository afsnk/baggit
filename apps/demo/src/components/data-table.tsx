    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>
            Transaciton details for {item.reference}
          </DrawerDescription>
        </DrawerHeader>
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          <List>
            <ListItem title="Webhook" description={item.callbackUrl} />
            <ListItem title="Amount" description={item.amount.toFixed(2)} />
            <ListItem title="Asset" description={item.asset} />
            <ListItem title="Network" description={item.network} />
            <ListItem
              title="Status"
              description={
                <Badge
