...
import { cn } from '#/lib/utils.ts' // Assuming you have a utility for class names
...
export const PaymentFlowStepper = ({
  className,
  steps,
  currentStep,
  headerTitle,
  ...
  return (
    <div className={cn('lg:max-w-md w-full', className)}>
      ...
      <p className="text-muted-foreground mt-4 text-xs lg:text-sm text-center lg:text-balance">
