    ...
    return (
      <>
        ...
        >
          ...
          <div className="absolute -left-4 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-muted" />
          <div className="absolute -right-4 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-muted" />
          ...
          <div className="px-8 pb-8 space-y-6">
            ...
            <div className="relative grid gap-2">
              ...
              <ArrowDown className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 p-1 bg-card rounded-full" />
              <div className="bg-muted/50 p-4 rounded-lg flex items-center space-x-4">
                <MastercardIcon />
                <div>
            ...
            <Button variant="link">
              Download Receipt <ArrowRight className="-rotate-45 size-4" />
            </Button>
            <Button variant="link">
              View Hash <ArrowRight className="-rotate-45 size-4" />
            </Button>
